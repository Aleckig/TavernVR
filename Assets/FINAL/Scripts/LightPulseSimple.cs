...
public class LightPulseSimple : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Generate random values for pulse speed
    ...
    void Update()
    {
        ...
        if (durationTimer <= 0f)
        {
            // Generate new random values for pulse speed and duration
            GenerateRandomValues();
    ...
    {
        // Generate a random pulse speed within the specified range
